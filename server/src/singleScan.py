...
def xmlToJson(pathToTheFile):
    pathToFile = pathToTheFile             		#PathToFile(eg. data/output.xml)
    ...
    for port in ports:
        ...
        portsInfoJson.append({"protocolType": protocolType, "portNumber": portNumber, "stateValue": stateValue, "serviceName": serviceName}) # Add each portInfo to dictionary
